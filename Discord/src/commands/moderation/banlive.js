...
module.exports = class banLive {
    constructor() {
        this.name = 'banlive';
        this.alias = ['banliveplayer'];
    ...
    getParameters(message, server) {
        return new Promise(async (resolve, reject) => {
            ...
            askPlayerName: while (true) {
                ...
                // Do matching
                const matchedPlayer = PlayerMatching.getBestPlayerMatch(banId, playerNames);
                if (!matchedPlayer) {
                ...
                switch (matchedPlayer.type) {
                    case "good":
                        banId = matchedPlayer.playerName;
                        break askPlayerName;
                    case "far":
